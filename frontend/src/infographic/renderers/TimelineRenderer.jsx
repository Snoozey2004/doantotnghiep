        ...
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            {steps.map((step, idx) => (
              ...
              >
                <div style={{ flexShrink: 0, width: '100px', fontWeight: '700', color: textColor || '#d2691e', fontSize: '1.2rem' }}>
                  {step.year}
                </div>
                <div>
                  <h3 style={{ margin: '0 0 10px 0', color: textColor || '#333', fontSize: '1.4rem' }}>{step.title}</h3>
                  <div
                    style={{ margin: 0, color: textColor || '#666', lineHeight: '1.6' }}
